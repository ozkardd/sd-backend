...
const RegisterPayment = (_req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const payment = yield paymentService.RegisterPayment(paymentInfo, next);
        const outDto = {
            data: payment,
            resultCode: 201,
        ...
        return next(new exceptions_1.InternalServerException(`There was an unexpected error with the RegisterPayment controller. ${e.message}`));
    }
});
